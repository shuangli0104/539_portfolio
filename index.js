...
//     }
    ...
    var images=new Array('img/Iceland-river.jpg','img/Iceland-pancake.jpg','img/Iceland-townhouse.jpg');
    ...
    function buttonShow(x){
      let showBtn = x.nextElementSibling;
      showBtn.style.display = "block";
      x.style.opacity= "0.7";
    }
    function buttonHidden(x){
      let hideBtn = x.nextElementSibling;
